      ...
      <div className="h-full max-w-4xl mx-auto flex flex-col p-3">
            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              <div className="bg-blue-50 rounded-xl p-8 max-w-2xl">
                ...
                <p className="text-gray-600 mb-4">
                  I am here to help you with anything you like to know. You can ask me about:
                </p>
        ...
        <form onSubmit={generateAnswer} className="bg-white rounded-lg shadow-lg p-4">
          <div className="flex gap-2">
            <textarea
              required
              className="flex-1 border border-gray-300 rounded p-3 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 resize-none max-h-40"
              value={question}
